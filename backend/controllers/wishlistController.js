...
exports.addToWishlist = async (req, res) => {
  ...
  try {
    ...
    res.status(500).json({ message: 'Error adding item to wishlist', error: error.toString() });
  }
};
...
exports.removeFromWishlist = async (req, res) => {
  ...
  try {
    ...
    res.status(500).json({ message: 'Error removing item from wishlist', error: error.toString() });
  }
};
